    ...
    <div class="container">
        ...
        <div class="section_news">
            ...
            <?php while ( have_posts() ) : the_post();
                get_template_part( 'template-parts/content-posts-inline');
            endwhile;?>
            </div>
...
<?php
unset($category, $category_slug, $posts_count, $posts_per_page, $pages, $current_page, $last_pages_count, $first_pages_count, $all_pages_count, $all_last_pages, $first_pages, $last_pages);
get_sidebar();
get_footer();